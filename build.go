...
const (
	...
	originalTarPieces string = "TAA=\"/mtd_rwcommon/widgets/user/WhiteRaven/server/wrserver.taa\"\n"
	middleTarPieces   string = "/mtd_rwcommon/widgets/user/WhiteRaven/server/wrserver."
